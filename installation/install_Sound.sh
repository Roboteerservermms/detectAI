...
sudo apt-get install python3.7-dev pybind11-dev liblapack-dev gfortran libatlas-base-dev python3-werkzeug -y
sudo python3.7 -m pip install pybind11
sudo LLVM_CONFIG=/usr/bin/llvm-config python3.7 -m pip install librosa
sudo apt-get install python3-scipy -y
sudo python3.7 -m pip install scipy --upgrade 
